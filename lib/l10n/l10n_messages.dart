...
abstract class L10nMessages {
  ...
  static LocalizedMessage get tutorialTitle => (l10n) => l10n.tutorialTitle;

  static LocalizedMessage get learningHeader => (l10n) => l10n.learningHeader;

  static LocalizedMessage get learningSubheader => (l10n) => l10n.learningSubheader;

  static LocalizedMessage get labelStatic => (l10n) => l10n.labelStatic;

  static LocalizedMessage get exampleStatic => (l10n) => l10n.exampleStatic;

  static LocalizedMessage get labelDynamic => (l10n) => l10n.labelDynamic;
  ...
  static LocalizedMessage get labelPlural => (l10n) => l10n.labelPlural;
  ...
  static LocalizedMessage get instructionSwitch => (l10n) => l10n.instructionSwitch;
